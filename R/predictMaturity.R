...
predictMaturity=function(model,modelName,dir){
  ...
  raster::writeRaster(predictedIMAT_Chartreuse,filename = paste("./../data/outputs/predicted",modelName,"_Chartreuse.tif"),format="GTiff",prj=T,overwrite=T)
  ...
  raster::writeRaster(predictedIMAT_VercorsRBI,filename = paste("./../data/outputs/predicted",modelName,"_VercorsRBI.tif"),format="GTiff",prj=T,overwrite=T)
  ...
  raster::writeRaster(predictedIMAT_QuatreMontagnes,filename = paste("./../data/outputs/predicted",modelName,"_QuatreMontagnes.tif"),format="GTiff",prj=T,overwrite=T)
