...
combineStandExtraMasks=function(modelName){
  ...
  extraBauges=raster::raster(paste("./../data/outputs/predicted",modelName,"_Bauges_extra.tif",sep=""))
  ...
  extraBugey=raster::raster(paste("./../data/outputs/predicted",modelName,"_Bugey_extra.tif",sep=""))
  ...
  extraChartreuse=raster::raster(paste("./../data/outputs/predicted",modelName,"_Chartreuse_extra.tif",sep=""))
  ...
  extraVercorsRBI=raster::raster(paste("./../data/outputs/predicted",modelName,"_VercorsRBI_extra.tif",sep=""))
  ...
  extraQuatreMontagnes=raster::raster(paste("./../data/outputs/predicted",modelName,"_QuatreMontagnes_extra.tif",sep=""))
