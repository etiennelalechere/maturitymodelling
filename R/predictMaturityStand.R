...
predictMaturityStand=function(modelName){
  ...
  raster::writeRaster(predictedIMAT_Bauges_stands,filename = paste("./../data/outputs/predicted",modelName,"_Bauges_60m_stands.tif",sep=""),format="GTiff",prj=T,overwrite=T)
  ...
  raster::writeRaster(predictedIMAT_Bugey_stands,filename = paste("./../data/outputs/predicted",modelName,"_Bugey_60m_stands.tif",sep=""),format="GTiff",prj=T,overwrite=T)
  ...
  raster::writeRaster(predictedIMAT_Chartreuse_stands,filename = paste("./../data/outputs/predicted",modelName,"_Chartreuse_60m_stands.tif",sep=""),format="GTiff",prj=T,overwrite=T)
  ...
  raster::writeRaster(predictedIMAT_VercorsRBI_stands,filename = paste("./../data/outputs/predicted",modelName,"_VercorsRBI_60m_stands.tif",sep=""),format="GTiff",prj=T,overwrite=T)
  ...
  raster::writeRaster(predictedIMAT_QuatreMontagnes_stands,filename = paste("./../data/outputs/predicted",modelName,"_QuatreMontagnes_60m_stands.tif",sep=""),format="GTiff",prj=T,overwrite=T)
